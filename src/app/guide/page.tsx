...
const RESTAURANTS = [
  ...
  { name: 'El Chapo', zone: 'General Luna', price: '₱₱', priceLevel: 2, cuisine: 'Mexican · Tacos', desc: 'The island\'s go-to taco spot. Bold flavors, generous portions, cold drinks. Always packed at dinner — arrive early or wait.', specialty: 'Tacos — must order the pork tacos', coord: { lat: 9.7905, lng: 126.1612 }, highlight: false },
