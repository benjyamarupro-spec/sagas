...
const ATTRACTIONS = [
  { name: 'Cloud 9 Surfing Area', query: 'Cloud 9 Surfing Area General Luna Siargao Philippines', type: 'surf', color: '#0A5C54' },
  { name: 'General Luna', query: 'General Luna town center Siargao Philippines', type: 'town', color: '#E8B44A' },
  { name: 'Maasin River', query: 'Maasin River Siargao Philippines', type: 'nature', color: '#1565C0' },
  { name: 'Beto Cold Spring', query: 'Beto Cold Spring Siargao Philippines', type: 'nature', color: '#2E7D32' },
  { name: 'Pacifico Beach', query: 'Pacifico Beach Siargao Philippines', type: 'beach', color: '#6A1B9A' },
  { name: 'Alegría Beach', query: 'Alegria Beach Siargao Philippines', type: 'beach', color: '#E65100' },
  { name: 'Sugba Lagoon', query: 'Sugba Lagoon Del Carmen Siargao Philippines', type: 'lagoon', color: '#0277BD' },
];

const RESTAURANTS = [
  { name: 'Alma Siargao', zone: 'General Luna', price: '₱₱₱', priceLevel: 3, cuisine: 'Spanish · Mediterranean', desc: "Benjamin's personal favorite. Alma is Siargao's finest Spanish restaurant — beachfront, intimate, and genuinely exceptional. Chef Luis Martinez brings sun-soaked Mediterranean flavors to the island.", specialty: 'Tapas & paella — must order both', coord: { lat: 9.7820, lng: 126.1520 }, highlight: true },
  { name: 'Ferns', zone: 'General Luna', price: '₱₱₱', priceLevel: 3, cuisine: 'International · Garden dining', desc: 'Elegant garden setting, one of the most beautiful restaurants on the island. Creative international menu with a strong focus on fresh ingredients.', specialty: 'Pasta & grilled meats — both excellent', coord: { lat: 9.7835, lng: 126.1535 }, highlight: false },
  { name: 'Wild Artisan Kitchen', zone: 'General Luna', price: '₱₱₱', priceLevel: 3, cuisine: 'Artisan · Natural', desc: 'Farm-to-table concept using local Siargao ingredients. Creative, beautifully presented dishes in a relaxed open-air setting.', specialty: 'Adobe — delicious. Drinks are very good too.', coord: { lat: 9.7842, lng: 126.1545 }, highlight: false },
  { name: 'Roots', zone: 'General Luna', price: '₱₱₱', priceLevel: 3, cuisine: 'Healthy · Filipino organic', desc: 'Set menu concept using 100% Filipino ingredients — everything is local, seasonal, and delicious. No single dish to order; just trust the menu.', specialty: 'Full set menu — all from the Philippines, all excellent', coord: { lat: 9.7848, lng: 126.1558 }, highlight: false },
  { name: 'Hapag', zone: 'General Luna', price: '₱₱', priceLevel: 2, cuisine: 'Filipino · Comfort food', desc: 'Authentic Filipino home cooking at its best. Unpretentious, generous portions, deeply satisfying.', specialty: 'Crispy sisig & Bicol express — both must-orders', coord: { lat: 9.7855, lng: 126.1562 }, highlight: false },
  { name: 'Cev', zone: 'General Luna', price: '₱₱', priceLevel: 2, cuisine: 'Ceviche · Seafood bar', desc: 'The island\'s best ceviche spot. Fresh catch, citrus-marinated, with creative flavor combinations. Perfect lunch spot.', specialty: 'General Luna ceviche — the best on the menu', coord: { lat: 9.7861, lng: 126.1570 }, highlight: false },
  { name: 'Amore', zone: 'General Luna', price: '₱₱', priceLevel: 2, cuisine: 'Italian · Pizza', desc: 'Proper wood-fired pizza on a tropical island. The pastas and pizzas are both excellent — consistently good, great for groups.', specialty: 'Pizzas — thin crust, perfectly done', coord: { lat: 9.7868, lng: 126.1578 }, highlight: false },
  { name: 'Lamari Siargao', zone: 'General Luna', price: '₱₱', priceLevel: 2, cuisine: 'Seafood · Filipino', desc: 'The vibe here is unmatched — right on the water, relaxed energy, and the kitchen delivers across the entire menu. Great for groups.', specialty: 'Everything is good — trust the daily specials', coord: { lat: 9.7875, lng: 126.1585 }, highlight: false },
  { name: 'Nami', zone: 'General Luna', price: '₱₱', priceLevel: 2, cuisine: 'Japanese · Sushi', desc: 'Surprisingly excellent Japanese restaurant. Cozy Japanese-themed decor, attentive staff, and genuinely fresh ingredients. A must-visit for sushi lovers.', specialty: 'Bowls & sushi — both outstanding', coord: { lat: 9.7882, lng: 126.1592 }, highlight: false },
  { name: 'White Beard', zone: 'General Luna', price: '₱₱', priceLevel: 2, cuisine: 'Café · Brunch · Bar', desc: 'The best spot for breakfast and brunch on the island. Relaxed vibe, great coffee, solid food. Also works well as a sundowner bar in the evenings.', specialty: 'Brunch — go for the morning sessions', coord: { lat: 9.7890, lng: 126.1598 }, highlight: false },
  { name: 'La Mesa', zone: 'General Luna', price: '₱₱', priceLevel: 2, cuisine: 'Thai · Asian fusion', desc: 'Thai restaurant with very good execution. Consistent quality, generous portions, fair prices. A reliable choice for Asian food on the island.', specialty: 'Pad Thai & Thai basil stir-fried — both excellent', coord: { lat: 9.7898, lng: 126.1605 }, highlight: false },
  { name: 'Backside Burger', zone: 'Cloud 9', price: '₱₱', priceLevel: 2, cuisine: 'Burgers · Casual', desc: 'Post-surf burgers right at the Cloud 9 boardwalk. The best burger on the island — full stop. Cold beer, great views of the break, surfer energy.', specialty: 'The burger — best on the island', coord: { lat: 9.8115, lng: 126.1740 }, highlight: false },
  { name: 'El Chapo', zone: 'General Luna', price: '₱₱', priceLevel: 2, cuisine: 'Mexican · Tacos', desc: 'The island\'s go-to taco spot. Bold flavors, generous portions, cold drinks. Always packed at dinner — arrive early or wait.', specialty: 'Tacos — very good, especially fish tacos', coord: { lat: 9.7905, lng: 126.1612 }, highlight: false },
  { name: 'Las Barricas', zone: 'General Luna', price: '₱₱', priceLevel: 2, cuisine: 'Bar · Spanish vibes', desc: 'The evening spot. Live music, great ambiance, sangria, and tapas. Las Barricas comes alive at night — one of the best places on the island for a night out.', specialty: 'Evening drinks + live music — the full experience', coord: { lat: 9.7912, lng: 126.1618 }, highlight: false },
  { name: 'CFC Siargao', zone: 'General Luna', price: '₱', priceLevel: 1, cuisine: 'Fried Chicken · Local', desc: 'The budget institution of Siargao. Crispy, cheap, and deeply satisfying. Conveniently located next to Mad Monkey Catangnan. Best value on the island.', specialty: 'Chicken combo — unbeatable for the price', coord: { lat: 9.7778, lng: 126.1455 }, highlight: false },
];
    ...
    const initMap = () => {
      ...
      ATTRACTIONS.forEach(attraction => {
        service.findPlaceFromQuery(
          { query: attraction.query, fields: ['geometry', 'name'] },
            ...
            if (status === window.google.maps.places.PlacesServiceStatus.OK && results?.[0]?.geometry?.location) {
              const marker = new window.google.maps.Marker({
                ...
                icon: {
                  ...
                  fillColor: attraction.color, fillOpacity: 1, strokeColor: 'white', strokeWeight: 1.5, scale: 1.6,
                  anchor: new window.google.maps.Point(12, 22),
                },
              });
              const infoWindow = new window.google.maps.InfoWindow({
                content: `<div style="font-family:Syne,sans-serif;padding:8px;min-width:160px"><p style="font-weight:800;font-size:14px;margin:0 0 4px;color:#071315">📍 ${attraction.name}</p><p style="font-size:12px;color:${attraction.color};margin:0;font-weight:600;text-transform:uppercase;letter-spacing:1px">${attraction.type}</p></div>`,
              });
      ...
      const visible = filter === 'all' ? RESTAURANTS : RESTAURANTS.filter(r => r.priceLevel === filter);
      visible.forEach(restaurant => {
        const pc = PRICE_COLORS[restaurant.priceLevel];
        service.findPlaceFromQuery(
          { query: `${restaurant.name} General Luna Siargao Philippines`, fields: ['geometry', 'name'] },
          (results: any[], status: string) => {
            if (status === window.google.maps.places.PlacesServiceStatus.OK && results?.[0]?.geometry?.location) {
              const marker = new window.google.maps.Marker({
                position: results[0].geometry.location,
              ...
              const infoWindow = new window.google.maps.InfoWindow({
                content: `<div style="font-family:Syne,sans-serif;padding:8px;min-width:180px"><p style="font-weight:800;font-size:14px;margin:0 0 4px;color:#071315">${restaurant.name}${restaurant.highlight ? ' ⭐' : ''}</p><p style="font-size:12px;color:#4A9080;margin:0 0 4px">${restaurant.cuisine}</p><p style="font-size:13px;font-weight:800;color:${pc.color};margin:0 0 6px">${restaurant.price}</p><p style="font-size:12px;color:#071315;margin:0;font-style:italic">${restaurant.specialty}</p></div>`,
              });
              marker.addListener('click', () => infoWindow.open(map, marker));
            }
          }
...
export default function GuidePage() {
  ...
  return (
    <div>
      ...
      {/* HEADER */}
      <div style={{ background: 'var(--nightsurf)', padding: isMobile ? '36px 20px 32px' : '56px 40px 48px' }}>
        <div style={{ maxWidth: 860, margin: '0 auto' }}>
          <p style={{ fontFamily: 'Syne', fontWeight: 400, fontSize: 12, color: 'rgba(255,255,255,0.35)', marginBottom: 10, letterSpacing: 1 }}>
            BY THE SAGAS TEAM · LOCAL EXPERTS · UPDATED 2025
          </p>
          <h1 style={{ fontFamily: 'Syne', fontWeight: 800, fontSize: isMobile ? 34 : 52, color: 'white', lineHeight: 1.1, marginBottom: 14 }}>
            The Complete Guide<br />to Siargao
          </h1>
          <p style={{ fontFamily: 'Syne', fontWeight: 400, fontSize: isMobile ? 15 : 18, color: 'rgba(255,255,255,0.55)', lineHeight: 1.6 }}>
            Everything you need to know to get there, get around,{isMobile ? ' ' : <br />}and fall in love with the island.
          </p>
        </div>
      </div>
      ...
      <nav style={{ position: 'sticky', top: 64, background: 'var(--nightsurf)', borderBottom: '1px solid rgba(255,255,255,0.1)', zIndex: 40, overflowX: 'auto' }}>
        <div style={{ display: 'flex', padding: isMobile ? '0 16px' : '0 40px', minWidth: 'max-content' }}>
          {TABS.map(tab => (
            <button key={tab.id} onClick={() => scrollTo(tab.id)} style={{
              ...
              fontFamily: 'Syne', fontWeight: activeTab === tab.id ? 600 : 400, fontSize: isMobile ? 12 : 13,
              padding: isMobile ? '14px 14px' : '16px 20px', cursor: 'pointer', whiteSpace: 'nowrap', transition: 'all 0.2s',
            }}>
              {tab.label}
            </button>
          ))}
      ...
      <div style={{ background: 'var(--seafoam)' }}>
        <div style={{ maxWidth: 1060, margin: '0 auto', padding: isMobile ? '0 16px' : '0 40px' }}>

          {/* OVERVIEW */}
          <section id="overview" style={{ paddingTop: 48, paddingBottom: 40, scrollMarginTop: 130 }}>
            <h2 style={{ fontFamily: 'Syne', fontWeight: 800, fontSize: isMobile ? 22 : 28, color: 'var(--nightsurf)', marginBottom: 18 }}>Overview</h2>
            <div style={{ display: 'grid', gridTemplateColumns: isMobile ? 'repeat(2, 1fr)' : 'repeat(4, 1fr)', gap: 12 }}>
              {[
                ...
                <div key={i} style={{ background: 'white', border: '1px solid var(--border)', borderRadius: 12, padding: isMobile ? '14px 16px' : '20px 22px' }}>
                  ...
                  <p style={{ fontFamily: 'Syne', fontWeight: 700, fontSize: isMobile ? 13 : 15, color: 'var(--nightsurf)' }}>{item.value}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          {/* HOW TO GET THERE */}
          <section id="how-to-get-there" style={{ paddingTop: 8, paddingBottom: 40, scrollMarginTop: 130 }}>
            <h2 style={{ fontFamily: 'Syne', fontWeight: 800, fontSize: isMobile ? 22 : 28, color: 'var(--nightsurf)', marginBottom: 8 }}>How to get there</h2>
            <p style={{ fontFamily: 'Syne', fontWeight: 400, fontSize: 14, color: 'var(--lagoon-muted)', marginBottom: 20 }}>All routes to Siargao explained.</p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              {[
                { from: 'From Cebu', best: 'Sunlight Air direct — 55 min — from ₱1,850', alt: 'Up to 5 daily departures. The easiest and cheapest gateway.', tip: 'Book at least 3 weeks ahead. Morning flights are usually cheapest.', code: 'CEB' },
                { from: 'From Clark (Angeles City)', best: 'Sunlight Air direct — 2h 30min — from ₱4,300', alt: 'Clark is 2h from Manila by P2P bus (₱250). Perfect for travelers from Luzon.', tip: 'Much less stressful than flying via NAIA. Take the P2P bus from Cubao or Pasay to Clark.', code: 'CRK' },
                { from: 'From Manila (NAIA)', best: 'Take P2P bus to Clark (2h) → Sunlight Air direct to Siargao (2h30)', alt: 'Sunlight Air no longer operates from NAIA. Clark is now the Luzon gateway.', tip: 'Total journey ~5h but stress-free. Buses every hour from Cubao & Pasay.', code: 'CRK' },
              ].map((r, i) => (
                <div key={i} style={{ background: 'white', border: '1px solid var(--border)', borderRadius: 12, padding: isMobile ? 18 : 24 }}>
                  ...
                  <div style={{ background: 'var(--seafoam)', borderRadius: 8, padding: '10px 14px', marginBottom: 14 }}>
          ...
          {/* BEST TIME */}
          <section id="best-time" style={{ paddingTop: 8, paddingBottom: 40, scrollMarginTop: 130 }}>
            <h2 style={{ fontFamily: 'Syne', fontWeight: 800, fontSize: isMobile ? 22 : 28, color: 'var(--nightsurf)', marginBottom: 8 }}>Best time to go</h2>
            <p style={{ fontFamily: 'Syne', fontWeight: 400, fontSize: 14, color: 'var(--lagoon-muted)', marginBottom: 20 }}>Price and weather guide by month.</p>
            {/* Calendar grid: 4 cols desktop, 2 cols mobile */}
            <div style={{ display: 'grid', gridTemplateColumns: isMobile ? 'repeat(2, 1fr)' : 'repeat(4, 1fr)', gap: isMobile ? 8 : 10, marginBottom: 20 }}>
              {MONTHS.map((mo, i) => {
                ...
                return (
                  <div key={i} style={{ background: bg, border: `1px solid ${border}`, borderRadius: 10, padding: isMobile ? '12px 14px' : '14px 16px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 4 }}>
                      <p style={{ fontFamily: 'Syne', fontWeight: 800, fontSize: 14, color: 'var(--nightsurf)' }}>{mo.m}</p>
                      <span style={{ fontSize: 14 }}>{mo.w}</span>
                    </div>
                    <p style={{ fontFamily: 'Syne', fontWeight: 800, fontSize: 15, color: 'var(--lagoon)', marginBottom: 2 }}>₱{formatPrice(mo.price)}</p>
                    <p style={{ fontFamily: 'Syne', fontWeight: 400, fontSize: 10, color: 'var(--lagoon-muted)' }}>{mo.crowd} crowds</p>
                    <p style={{ fontSize: 11, marginTop: 4 }}>{'⭐'.repeat(mo.stars)}</p>
                  </div>
                );
              })}
            </div>
            <div style={{ background: 'var(--golden-light)', border: '1px solid rgba(232,180,74,0.4)', borderRadius: 12, padding: '16px 20px' }}>
          ...
          {/* ISLAND ZONES */}
          <section id="island-zones" style={{ paddingTop: 8, paddingBottom: 40, scrollMarginTop: 130 }}>
            <h2 style={{ fontFamily: 'Syne', fontWeight: 800, fontSize: isMobile ? 22 : 28, color: 'var(--nightsurf)', marginBottom: 8 }}>Island zones</h2>
            <p style={{ fontFamily: 'Syne', fontWeight: 400, fontSize: 14, color: 'var(--lagoon-muted)', marginBottom: 20 }}>7 distinct areas — each with its own vibe.</p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: 16 }}>
              {ZONES.map((z, i) => (
                <div key={i} style={{ background: 'white', border: '1px solid var(--border)', borderRadius: 12, overflow: 'hidden' }}>
                  <img src={z.img} alt={z.name} style={{ width: '100%', height: isMobile ? 160 : 200, objectFit: 'cover', display: 'block' }} />
          ...
          {/* RESTAURANTS */}
          <section id="restaurants" style={{ paddingTop: 8, paddingBottom: 40, scrollMarginTop: 130 }}>
            <h2 style={{ fontFamily: 'Syne', fontWeight: 800, fontSize: isMobile ? 22 : 28, color: 'var(--nightsurf)', marginBottom: 8 }}>Restaurants</h2>
            <p style={{ fontFamily: 'Syne', fontWeight: 400, fontSize: 14, color: 'var(--lagoon-muted)', marginBottom: 20 }}>15 restaurants picked by the SAGAS team — locals who actually eat here.</p>
            ...
            {/* Restaurant list: 3 cols desktop, 1 col mobile */}
            <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(3, 1fr)', gap: 14 }}>
              {RESTAURANTS.map((r, i) => {
                const pc = PRICE_COLORS[r.priceLevel];
                return (
                  <div key={i} style={{ background: 'white', border: r.highlight ? '2px solid var(--golden)' : '1px solid var(--border)', borderRadius: 12, padding: 20, position: 'relative' }}>
                    {r.highlight && (
          ...
          {/* BUDGET */}
          <section id="budget" style={{ paddingTop: 8, paddingBottom: 40, scrollMarginTop: 130 }}>
            <h2 style={{ fontFamily: 'Syne', fontWeight: 800, fontSize: isMobile ? 22 : 28, color: 'var(--nightsurf)', marginBottom: 8 }}>Budget guide</h2>
            <p style={{ fontFamily: 'Syne', fontWeight: 400, fontSize: 14, color: 'var(--lagoon-muted)', marginBottom: 20 }}>What to expect at every budget level.</p>
          ...
          <section id="tips" style={{ paddingTop: 8, paddingBottom: 56, scrollMarginTop: 130 }}>
            <h2 style={{ fontFamily: 'Syne', fontWeight: 800, fontSize: isMobile ? 22 : 28, color: 'var(--nightsurf)', marginBottom: 8 }}>Tips & tricks</h2>
            <p style={{ fontFamily: 'Syne', fontWeight: 400, fontSize: 14, color: 'var(--lagoon-muted)', marginBottom: 20 }}>Insider knowledge from people who actually live here.</p>
            {/* 3 cols desktop, 1 col mobile */}
            ...
            {/* Bottom CTA */}
            <div style={{ background: 'var(--lagoon)', borderRadius: 16, padding: isMobile ? '28px 20px' : '40px', textAlign: 'center' }}>
              <p style={{ fontFamily: 'Syne', fontWeight: 800, fontSize: isMobile ? 22 : 28, color: 'white', marginBottom: 20 }}>
                Ready to book your flight to Siargao?
              </p>
              <Link href="/flights" style={{ background: 'var(--coral)', color: 'white', borderRadius: 10, padding: '14px 32px', fontFamily: 'Syne', fontWeight: 800, fontSize: 15, textDecoration: 'none', display: 'inline-block' }}>
                Search flights now →
              </Link>
            </div>
          </section>
